...
- `clinic/` のFEATUREセクションは、PC幅では左側の縦書きコピーとタイムラインをsticky表示し、右側の導入カードと4枚の特徴カードをスクロールに応じて1枚ずつ重ねる。特徴カードは写真・ラベル・見出し・本文を1枚の白い3:2比率カード内に収め、重なりパネルや斜めカット装飾は使わない。1024px未満ではsticky演出を解除し、通常の縦積み表示にする。
