...
- `clinic/` のFVは、PC幅では左上の白い横長ロゴカード、上部の白いナビバー、現行ヒーロースライダー画像を使った大きな写真ステージ、中央寄りの縦書きコピー、左側のSCROLL導線、右側の縦型メニューボタンで構成する。角のイラスト装飾は置かない。
- `clinic/` のFVは、モバイル幅でもキャッチコピーを画面中央付近へ配置し、PCと同じ白帯つきの縦書き表現を基準にする。
